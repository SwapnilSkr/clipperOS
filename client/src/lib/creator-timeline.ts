...
import { MAX_SPEED_RATE, MIN_SPEED_RATE } from "@/api";
...
//
// A verbatim port of server/src/services/creator-timeline.ts. If a rule
// changes there, change it here; server/scripts/validate-creator.ts asserts
// the two agree.
// ============================================
